# Projeto 4 — Ferramenta utilizável

Lanterna utilizável em teclado, gamepad e touch com estado local acessível.

- Início pedagógico: capítulo 4.3
- Conclusão pedagógica: capítulo 4.6
- Comportamento: Equipar → acionar → luz alterna → respawn restaura estado
