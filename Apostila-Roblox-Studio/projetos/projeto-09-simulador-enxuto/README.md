# Projeto 9 — Simulador enxuto

Vertical slice autoritativa de mineração, venda, upgrade, área e missão.

- Início pedagógico: capítulo 7.4
- Conclusão pedagógica: capítulo 7.5
- Comportamento: Minerar → mochila → vender → melhorar → liberar área → repetir
